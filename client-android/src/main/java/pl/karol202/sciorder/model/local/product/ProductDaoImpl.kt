...
fun ProductEntityDao.toProductDao(): ProductDao =
	ProductDaoImpl(this)

private class ProductDaoImpl(private val productEntityDao: ProductEntityDao) :
	ProductDao
{
	@WorkerThread
	...
	private fun Product.toProductEntity() =
		ProductEntity(_id, name, available, parameters)
}