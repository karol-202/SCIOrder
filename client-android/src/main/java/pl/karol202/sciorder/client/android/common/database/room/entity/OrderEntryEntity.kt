...
{
	companion object : ToEntityMapper<OrderEntryEntity, OrderEntry>
	{
		override fun toEntity(model: OrderEntry) = OrderEntryEntity(model.id, model.orderId, model.productId, model.quantity)
	}
}
