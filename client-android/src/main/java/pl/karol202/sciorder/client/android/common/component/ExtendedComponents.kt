...
abstract class ExtendedFragment : InflatedFragment(), ComponentWithInstanceState, ComponentWithArguments
{
...
abstract class ExtendedDialogFragment : DialogFragment(), ComponentWithArguments
{
	override var componentArguments: Bundle?
		get() = arguments
		set(value) { arguments = value }
...
abstract class ExtendedAlertDialog(context: Context) : AlertDialog(context), ComponentWithInstanceState
{
	override val instanceState = InstanceState()
