...
fun viewModelsModule() = module {
	...
	viewModel { AdminOrdersAndroidViewModel(get(), get(), get(), get()) }
	viewModel { AdminProductsAndroidViewModel(get(), get(), get()) }
	viewModel { AdminProductEditAndroidViewModel(get(), get(), get()) }
	viewModel { AdminStoresAndroidViewModel(get(), get()) }
	viewModel { UserLoginAndroidViewModel(get(), get(), get(), get()) }
